...
while True:
    ...
    if hit_ball.xcor() > 500:
        ...
        sketch.clear()
        sketch.write("Left_player : {} Right_player: {}".format(left_player,right_player), align = "center", font = ("Curier",24,"normal"))
    ...
    if hit_ball.xcor() < -500:
        ...
        right_player += 1
        sketch.clear()
        sketch.write("Left_palyer:{} Right_player:{}".format(left_player,right_player), align = "center",font=("Courier",24, "normal"))
